...
void NormAutocorrGPU::run() {
   try {
      ...
      try_cuda_func( cerror, cudaMemcpyAsync( d_samples, samples.data(), adjusted_num_sample_bytes,
      ...
      try_cuda_func( cerror, cudaMemcpyAsync( norms.data(), d_norms, adjusted_num_norm_bytes,
